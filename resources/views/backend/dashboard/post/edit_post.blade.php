        ...
        <div class="col-lg-8">
            <form action="/dashboard/posts/{{ $post->slug }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input name="judul" type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" value="{{ old('judul',$post->judul) }}" required autofocus>
                    @error('judul')
                ...
                <div class="mb-3">
                    ...
                    <input name="slug" type="text" class="form-control" id="slug" value="{{ old('slug',$post->slug) }}">
                </div>
